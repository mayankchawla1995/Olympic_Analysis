...
if (user_menu)=='Medal Tally':
      ...
      if selected_year != 'Overall' and selected_country == 'Overall':
          st.title("Medal tally in year "+str(selected_year)+"Olympics")
      if selected_year == 'Overall' and selected_country != 'Overall':
...
if user_menu == "Athlete wise Analysis":
    ...
    x=[]
    name=[]
    famous_sports = ['Basketball', 'Judo', 'Football', 'Athletics', 'Swimming', 'Badminton', 'Gymnastics',
                     'Weightlifting', 'Wrestling', 'Hockey', 'Shooting', 'Boxing', 'Table Tennis', 'Volleyball',]
